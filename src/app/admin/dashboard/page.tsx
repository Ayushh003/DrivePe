        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              disabled={refreshing}
              className="inline-flex items-center gap-1.5 px-3 py-2 rounded-xl bg-white border border-slate-200 text-xs font-semibold text-slate-700 hover:bg-slate-50 hover:text-brand-600 shadow-xs transition-colors disabled:opacity-60"
              title="Refresh Analytics & Bookings"
            >
              ...
              <div className="flex items-center gap-2">
                ...
                {analytics?.pendingBookings > 0 ? (
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full bg-amber-100 text-amber-800 text-xs font-bold border border-amber-300">
                    ...
                    {analytics.pendingBookings} Awaiting Verification
                  </span>
                ) : (
